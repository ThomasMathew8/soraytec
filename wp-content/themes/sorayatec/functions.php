...
function custom_post_type_init() {
  ...
  /*******CPT-History start*******/
    ...
    'add_new' => __('Add New History', 'Sorayatec'),
    'add_new_item' => __('Add New History', 'Sorayatec'),
    'edit_item' => __('Edit History', 'Sorayatec'),
    'new_item' => __('New History', 'Sorayatec'),
    'all_items' => __('All Histories', 'Sorayatec'),
    'view_item' => __('View Histories', 'Sorayatec'),
    'search_items' => __('Search History', 'Sorayatec'),
    'not_found' =>  __('No History Found', 'Sorayatec'),
    'not_found_in_trash' => __('No History found in Trash', 'Sorayatec'), 
    'parent_item_colon' => '',
