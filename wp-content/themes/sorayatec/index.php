            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 text-right">
                        <div class="inner">
                            <h2>MISSION</h2>
                            <p>Deliver a medium voltage predictive smart grid solution</p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <figure><img src="<?php bloginfo("template_directory");?>/assets/images/mission-img.png" class="rounded-circle" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 order-md-1">
                        <div class="inner">
                            <h2>VALUES</h2>
                            <p>Enable a fully transparent electricity network for a global, clean, fair and ethical energy market.</p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <figure><img src="<?php bloginfo("template_directory");?>/assets/images/values-img.png" class="rounded-circle" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
